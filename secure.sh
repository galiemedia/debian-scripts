...
# Checks for "neofetch" used by previous version of debian-scripts and replaces it with "fastfetch" since "neofetch" is
# no longer maintained and the package is not available in Trixie.  Comment this if you would like to keep "neofetch".
...
# Prompting for common actions that help secure Debian including SSH, the firewall, fail2ban, upgrades, etc.
